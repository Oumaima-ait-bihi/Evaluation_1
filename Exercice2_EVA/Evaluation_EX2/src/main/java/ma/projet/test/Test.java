...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        emp1.setNom("Ait Bihi");
        emp1.setPrenom("Oumaima");
        employeService.create(emp1);

        Employe emp2 = new Employe();
        emp2.setNom("Ait Bihi");
        emp2.setPrenom("Fatimazahra ");
        ...
        LocalDate debut = LocalDate.of(2030, 4, 23);
        LocalDate fin = LocalDate.of(2030, 5, 10);
