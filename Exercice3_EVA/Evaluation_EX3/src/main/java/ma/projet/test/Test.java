...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Femme f1 = new Femme(); f1.setCin("F001"); f1.setNom("Oumaima"); f1.setPrenom("bihi"); f1.setDateNaissance(LocalDate.of(1965, 3, 12));
        Femme f2 = new Femme(); f2.setCin("F002"); f2.setNom("Fati"); f2.setPrenom("baraoui"); f2.setDateNaissance(LocalDate.of(1970, 7, 5));
        Femme f3 = new Femme(); f3.setCin("F003"); f3.setNom("qamar"); f3.setPrenom("nasiri"); f3.setDateNaissance(LocalDate.of(1980, 11, 4));
        Femme f4 = new Femme(); f4.setCin("F004"); f4.setNom("chams"); f4.setPrenom("boda"); f4.setDateNaissance(LocalDate.of(1968, 9, 3));
        Femme f5 = new Femme(); f5.setCin("F005"); f5.setNom("hadil"); f5.setPrenom("Ben"); f5.setDateNaissance(LocalDate.of(1975, 6, 10));

        Arrays.asList(f1, f2, f3, f4, f5).forEach(femmeService::create);


        Homme h1 = new Homme(); h1.setNom("Ayoub"); h1.setPrenom("bihi");
        Homme h2 = new Homme(); h2.setNom("Imrane"); h2.setPrenom("bnani");
        Homme h3 = new Homme(); h3.setNom("Younes"); h3.setPrenom("alaoui");
        ...
        Mariage m9 = new Mariage(); m9.setHomme(h3); m9.setFemme(f1); m9.setDateDebut(LocalDate.of(2007,4,1)); m9.setNbrEnfant(1);
        Mariage m10 = new Mariage(); m10.setHomme(h3); m10.setFemme(f2); m10.setDateDebut(LocalDate.of(2020,6,22)); m10.setNbrEnfant(0);
