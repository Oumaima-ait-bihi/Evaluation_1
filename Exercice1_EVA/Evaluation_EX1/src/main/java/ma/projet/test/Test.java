...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        c1.setDate(LocalDate.of(2003, 5, 20));
        ...
        System.out.println("\n--- Produits commandés entre 2003-02-22 et 2003-03-17 ---");
        LocalDate start = LocalDate.of(2003, 02, 22);
        LocalDate end = LocalDate.of(2003, 03, 17);
